...
static void canzero_serialize_canzero_message_mother_board_stream_state(canzero_message_mother_board_stream_state* msg, canzero_frame* frame) {
  ...
  frame->id = 0x91;
  frame->dlc = 2;
  ((volatile uint32_t*)data)[0] = (uint8_t)(msg->m_state & (0xFF >> (8 - 5)));
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_command & (0xFF >> (8 - 4))) << 5;
...
static void canzero_serialize_canzero_message_mother_board_stream_motor_command(canzero_message_mother_board_stream_motor_command* msg, canzero_frame* frame) {
  ...
  ((volatile uint32_t*)data)[0] = target_acceleration_0;
  ((volatile uint32_t*)data)[1] = (uint8_t)(msg->m_motor_driver_command & (0xFF >> (8 - 3)));
...
static void canzero_serialize_canzero_message_mother_board_stream_input_board_command(canzero_message_mother_board_stream_input_board_command* msg, canzero_frame* frame) {
  ...
  frame->id = 0x4F;
  frame->dlc = 1;
  ((volatile uint32_t*)data)[0] = (uint8_t)(msg->m_input_board_command & (0xFF >> (8 - 1)));
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_input_board_assert_45V_online & (0xFF >> (8 - 1))) << 1;
}
...
static void canzero_serialize_canzero_message_mother_board_stream_errors(canzero_message_mother_board_stream_errors* msg, canzero_frame* frame) {
  ...
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_any & (0xFF >> (8 - 1))) << 1;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_over_temperature_system & (0xFF >> (8 - 2))) << 2;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_level_config_consistency & (0xFF >> (8 - 2))) << 4;
...
static void canzero_deserialize_canzero_message_motor_driver_stream_errors(canzero_frame* frame, canzero_message_motor_driver_stream_errors* msg) {
  ...
  msg->m_error_level_current_u1 = (error_level)((((uint32_t*)data)[0] >> 16) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_current_v1 = (error_level)((((uint32_t*)data)[0] >> 18) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_current_w1 = (error_level)((((uint32_t*)data)[0] >> 20) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_current_u2 = (error_level)((((uint32_t*)data)[0] >> 22) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_current_v2 = (error_level)((((uint32_t*)data)[0] >> 24) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_current_w2 = (error_level)((((uint32_t*)data)[0] >> 26) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_vdc_voltage = (error_level)((((uint32_t*)data)[0] >> 28) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_board_temperature = (error_level)((((uint32_t*)data)[0] >> 30) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_mcu_temperature = (error_level)(((uint32_t*)data)[1] & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_lim_temperature = (error_level)((((uint32_t*)data)[1] >> 2) & (0xFFFFFFFF >> (32 - 2)));
...
static void canzero_deserialize_canzero_message_levitation_board1_stream_errors(canzero_frame* frame, canzero_message_levitation_board1_stream_errors* msg) {
  ...
  msg->m_error_level_vdc_voltage = (error_level)((((uint32_t*)data)[0] >> 12) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_magnet_current_left = (error_level)((((uint32_t*)data)[0] >> 14) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_magnet_current_right = (error_level)((((uint32_t*)data)[0] >> 16) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_input_current = (error_level)((((uint32_t*)data)[0] >> 18) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_magnet_temperature_left = (error_level)((((uint32_t*)data)[0] >> 20) & (0xFFFFFFFF >> (32 - 2)));
  msg->m_error_level_magnet_temperature_right = (error_level)((((uint32_t*)data)[0] >> 22) & (0xFFFFFFFF >> (32 - 2)));
...
static void canzero_deserialize_canzero_message_input_board_stream_linear_encoder(canzero_frame* frame, canzero_message_input_board_stream_linear_encoder* msg) {
  uint8_t* data = frame->data;
  uint32_t tmp_0 = ((uint32_t*)data)[0] & (0xFFFFFFFF >> (32 - 16));
  msg->m_linear_encoder_count = (tmp_0 & (((uint32_t)0x1) << (16 - 1)) != 0) ? (tmp_0 | (((uint32_t)0xFFFFFFFFul) << (16 - 1))) : tmp_0;
  msg->m_absolute_position_known = (bool_t)((((uint32_t*)data)[0] >> 16) & (0xFFFFFFFF >> (32 - 1)));
  msg->m_absolute_position_offset = ((((uint64_t*)data)[0] >> 17) & (0xFFFFFFFFFFFFFFFF >> (64 - 16))) * 0.0006103608758678569 + -10;
}
...
static const uint32_t heartbeat_interval = 166;
  ...
  for (uint8_t i = 0; i < 100; ++i) {
    ...
    switch (job->tag) {
      ...
      case HEARTBEAT_JOB_TAG: {
        ...
        heartbeat_can0.m_ticks_next = 60;
        ...
        heartbeat_can1.m_ticks_next = 60;
...
static PROGMEM void canzero_handle_get_req(canzero_frame* frame) {
  ...
  case 51: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_guidance_board_front_config_hash_rx_fragmentation_buffer, 2, 51, msg.m_header.m_client_id);
    break;
  }
  case 52: {
  ...
  case 76: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_guidance_board_back_config_hash_rx_fragmentation_buffer, 2, 76, msg.m_header.m_client_id);
    break;
  }
  case 77: {
  ...
  case 102: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_levitation_board1_config_hash_rx_fragmentation_buffer, 2, 102, msg.m_header.m_client_id);
    break;
  }
  case 103: {
  ...
  case 124: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_levitation_board2_config_hash_rx_fragmentation_buffer, 2, 124, msg.m_header.m_client_id);
    break;
  }
  case 125: {
  ...
  case 146: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_levitation_board3_config_hash_rx_fragmentation_buffer, 2, 146, msg.m_header.m_client_id);
    break;
  }
  case 147: {
  ...
  case 170: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_input_board_config_hash_rx_fragmentation_buffer, 2, 170, msg.m_header.m_client_id);
    break;
  }
  case 171: {
  ...
  case 219: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_power_board12_config_hash_rx_fragmentation_buffer, 2, 219, msg.m_header.m_client_id);
    break;
  }
  case 220: {
  ...
  case 228: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_power_board24_config_hash_rx_fragmentation_buffer, 2, 228, msg.m_header.m_client_id);
    break;
  }
  case 229: {
  ...
  case 236: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_led_board_config_hash_rx_fragmentation_buffer, 2, 236, msg.m_header.m_client_id);
    break;
  }
  case 237: {
...
static void canzero_handle_input_board_stream_linear_encoder(canzero_frame* frame) {
  canzero_message_input_board_stream_linear_encoder msg;
  canzero_deserialize_canzero_message_input_board_stream_linear_encoder(frame, &msg);
  canzero_set_linear_encoder_count(msg.m_linear_encoder_count);
  canzero_set_absolute_position_known(msg.m_absolute_position_known);
  canzero_set_absolute_position_offset(msg.m_absolute_position_offset);
}
  ...
  while (canzero_can1_recv(&frame)) {
    switch (frame.id) {
      ...
      case 0x198:
        ...
        break;
      case 0x158:
        canzero_handle_input_board_stream_linear_encoder(&frame);
        break;
      case 0x116:
...
void canzero_init() {
  __oe_config_hash = 7143755887413552109ull;
  __oe_build_time = {
    .m_year = BUILD_YEAR,
    .m_month = BUILD_MONTH,
    .m_day = BUILD_DAY,
...
void canzero_send_guidance_board_front_config_hash() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_guidance_board_front_config_hash_send_fragmentation_buffer, 2, 51, 255);
...
void canzero_send_guidance_board_back_config_hash() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_guidance_board_back_config_hash_send_fragmentation_buffer, 2, 76, 255);
...
void canzero_send_levitation_board1_config_hash() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_levitation_board1_config_hash_send_fragmentation_buffer, 2, 102, 255);
...
void canzero_send_levitation_board2_config_hash() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_levitation_board2_config_hash_send_fragmentation_buffer, 2, 124, 255);
...
void canzero_send_levitation_board3_config_hash() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_levitation_board3_config_hash_send_fragmentation_buffer, 2, 146, 255);
...
void canzero_send_input_board_config_hash() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_input_board_config_hash_send_fragmentation_buffer, 2, 170, 255);
...
void canzero_send_power_board12_config_hash() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_power_board12_config_hash_send_fragmentation_buffer, 2, 219, 255);
...
void canzero_send_power_board24_config_hash() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_power_board24_config_hash_send_fragmentation_buffer, 2, 228, 255);
...
void canzero_send_led_board_config_hash() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_led_board_config_hash_send_fragmentation_buffer, 2, 236, 255);
